...
export const diagramRelated: Array<string> = ['coreBelief', 'intermediateBelief', 'copingStrategies']

export const diagramCCD: Array<string> = ['situation', 'autoThought', 'emotion', 'behavior']
