...
export function DiagramList({ userId, chatId }: DiagramListProps) {
  ...
  useEffect(() => {
    ...
    fetchProfile()
  }, [isFetchedPatientProfile, userId, chatId])
  ...
  const handleCheckboxChange = (
    category: string,
    checkedValues: { id: string; label: string }[]
  ) => {
    setInputValues(prevValues => ({
      ...prevValues,
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex justify-end p-4">
        <button
          className="text-sm font-semibold h-[35px] w-[220px] items-center justify-center rounded-md bg-red-500 text-white"
